...
public class History_Facts extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mFactTextView = rootView.findViewById(R.id.historyfactTextView);
        showFactButton = rootView.findViewById(R.id.historyshowFactbutton);
        relativeLayout = rootView.findViewById(R.id.historyFragLayout);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("History_Facts");
    }
