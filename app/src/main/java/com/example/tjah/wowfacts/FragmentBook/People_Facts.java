...
public class People_Facts extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mFactTextView = (TextView) rootView.findViewById(R.id.peoplefactTextView);
        showFactButton = (Button) rootView.findViewById(R.id.peopleshowFactbutton);
        relativeLayout = (RelativeLayout) rootView.findViewById(R.id.pplFragLayout);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("People_Facts");
    }
