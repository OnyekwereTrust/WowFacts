...
public class Food_Facts extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mFactTextView = (TextView) rootView.findViewById(R.id.foodFactTextView);
        showFactButton = (Button) rootView.findViewById(R.id.foodshowFactbutton);
        relativeLayout = (RelativeLayout) rootView.findViewById(R.id.FoodFragLayout);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Food_Facts");
    }
