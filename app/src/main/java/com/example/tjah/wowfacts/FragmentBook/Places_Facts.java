...
public class Places_Facts extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mFactTextView = (TextView) rootView.findViewById(R.id.placesfactTextView);

        showFactButton = (Button) rootView.findViewById(R.id.placesshowFactbutton);
        relativeLayout = (RelativeLayout) rootView.findViewById(R.id.placesFragLayout);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Places_Facts");
    }
